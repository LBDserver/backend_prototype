...
export declare class ContextParser implements IDocumentLoader {
     ...
     */
    static assertNormalized(context: JsonLdContext): void;
    /**
     ...
     * @return {IJsonLdContextNormalized} The mutated input context.
     */
    static normalize(context: IJsonLdContextNormalized): IJsonLdContextNormalized;
    /**
     ...
     */
    protected static normalizeContextIri(contextIri: string, baseIri: string): string;
    /**
