...
var _sparqljsonParse = require("sparqljson-parse");
...
function (_ContentParser) {
  ...
  function SparqlJsonResultParser(config) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SparqlJsonResultParser).call(this, config));
    _this.parser = new _sparqljsonParse.SparqlJsonParser({
